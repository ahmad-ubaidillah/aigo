...
var ProviderRegistry = map[string]ProviderInfo{
	...
	"mistral":     {BaseURL: "https://api.mistral.ai/v1", APIKeyEnv: "MISTRAL_API_KEY", APIMode: "openai"},
	"cerebras":    {BaseURL: "https://api.cerebras.ai/v1", APIKeyEnv: "CEREBRAS_API_KEY", APIMode: "openai"},
	"fireworks":  {BaseURL: "https://api.fireworks.ai/v1", APIKeyEnv: "FIREWORKS_API_KEY", APIMode: "openai"},
	"deepinfra":   {BaseURL: "https://api.deepinfra.com/v1", APIKeyEnv: "DEEPINFRA_API_KEY", APIMode: "openai"},
	"novita":      {BaseURL: "https://api.novita.ai/v2", APIKeyEnv: "NOVITA_API_KEY", APIMode: "openai"},
	"cohere":      {BaseURL: "https://api.cohere.ai/v1", APIKeyEnv: "COHERE_API_KEY", APIMode: "openai"},
	"together":   {BaseURL: "https://api.together.ai/v1", APIKeyEnv: "TOGETHER_API_KEY", APIMode: "openai"},
	"cloudflare": {BaseURL: "https://api.cloudflare.com/client/v1/ai", APIKeyEnv: "CLOUDFLARE_API_KEY", APIMode: "openai"},
	"neural":     {BaseURL: "https://neural-chat.ai/api/v1", APIKeyEnv: "NEURAL_API_KEY", APIMode: "openai"},
	"sambanova":   {BaseURL: "https://api.sambanova.ai/v1", APIKeyEnv: "SAMBANOVA_API_KEY", APIMode: "openai"},
	"litellm":    {BaseURL: "", APIKeyEnv: "LITELLM_API_KEY", APIMode: "openai"},
	"anyscale":   {BaseURL: "https://api.anyscale.com/v1", APIKeyEnv: "ANYSCALE_API_KEY", APIMode: "openai"},
	"volcengine": {BaseURL: "https://ark.cn-beijing.volces.com/api/v3", APIKeyEnv: "VOLCENGINE_API_KEY", APIMode: "openai"},
	"moonshot":   {BaseURL: "https://api.moonshot.cn/v1", APIKeyEnv: "MOONSHOT_API_KEY", APIMode: "openai"},
	"wenxin":     {BaseURL: "https://qianfan.accelerate.cn/v1", APIKeyEnv: "WENXIN_API_KEY", APIMode: "openai"},
	"iFlytek":    {BaseURL: "https://spark-api.xf-yun.com/v1", APIKeyEnv: "IFLYTEK_API_KEY", APIMode: "openai"},
	"baidu":     {BaseURL: "https://qianfan.accelerate.cn/v1", APIKeyEnv: "BAIDU_API_KEY", APIMode: "openai"},
	"tongyi":    {BaseURL: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1", APIKeyEnv: "TONGYI_API_KEY", APIMode: "openai"},
	"azure-openai": {BaseURL: "", APIKeyEnv: "AZURE_OPENAI_API_KEY", APIMode: "azure"},
	"vllm":       {BaseURL: "http://localhost:8000/v1", APIKeyEnv: "VLLM_API_KEY", APIMode: "openai"},
	"textsynth": {BaseURL: "https://api.textsynth.com/v1", APIKeyEnv: "TEXTSYNTH_API_KEY", APIMode: "openai"},
}
...
func getDefaultModel(provider string) string {
	models := map[string]string{
		...
		"fireworks":  "fireworks-ai/firefunction-v2",
		"deepinfra":   "meta-llama/Llama-3.3-70B-Instruct",
		"novita":     "Nous-Noir-7B",
		"cohere":     "command-r-plus",
		"together":  "meta-llama/Meta-Llama-3.1-70B-Instruct",
		"cloudflare": "@cf/meta-llama/llama-3.1-8b-instruct",
